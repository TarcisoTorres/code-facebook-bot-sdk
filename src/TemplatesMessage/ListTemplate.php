...
class ListTemplate implements TemplateInterface
{
    ...
    public function setSummary(float $total_cost, float $sub_total = null, float $shipping_cost = null, float $total_tax)
    {
        $this->summary = [
